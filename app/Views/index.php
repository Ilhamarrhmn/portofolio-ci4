...
<head>
  ...
  <title>Ilham Arrahman | Software Developer</title>
...
<body>
    ...
    <ul class="side-nav fixed section table-of-contents">
      ...
      <li class="logo">
        <a id="logo-container" aria-label="Navigate to the beginning of the page" href="#intro"
          ...
          <img src="/assets/img/ilham.jpg" class="circle img-responsive profile-pic" alt="avatar">
        </a>
      </li>
  ...
  <nav class="hide-on-large only trigger z-depth-1">
    ...
    <div class="name-title">
      <a id="name" aria-label="Navigate to the beginning of the page" href="#" class="teal-text">ILHAM ARRAHMAN</a><span class="black-text">Software Developer</span>
    </div>
  </nav>
  ...
  <main>
      ...
      <div class="container">
        <div class="col-md-9">
          <div class="content section-padding valign" style="margin-left: 10%; margin-top: 50px;">
            <div class="caption">
              <h2>Halo, Saya <span class="teal">Ilham Arrahman.</span></h2>
              <h4 style="color:#fff"><span class="typing" style="font-weight: 400;"></span></h4>
              <h5> Sebagai seorang developer, Saya memiliki kemampuan teknis yang mumpuni dalam pengembangan perangkat lunak atau aplikasi. Saya memiliki pengetahuan dalam berbagai bahasa pemograman dan teknologi modern, serta pengalaman dalam mengerjakan proyek-proyek pengembangan baik secara individu maupun dalam tim.</h5>
            </div>
            <div class="social">
              <a href="https://github.com/Ilhamarrhmn" target="_blank">
    ...
    <section id="about" class="section scrollspy">
      ...
      <div class="container flow-text">  
        <p>
            Saya adalah mahasiswa Teknik Informatika di Universitas Muhammadiyah Sukabumi. Saya menikmati pemecahan masalah dan pengkodean, serta selalu berusaha memberikan 100% pada setiap pekerjaan yang saya lakukan. Saya memiliki pengalaman selama 2 tahun yang di bidang PHP khususnya Framework Laravel. Saya sangat bersemangat mengembangkan aplikasi kompleks yang menyelesaikan masalah dunia nyata yang mempengaruhi jutaan pengguna.
        </p>
        <p>
          <ul>
            <li><b>Languages:</b> Python, Java, JavaScript, C++, HTML/CSS, PHP</li>
            <li><b>Databases:</b> MySQL, PostgreSQL</li>
            <li><b>Libraries:</b> NumPy, Pandas, OpenCV</li>
            <li><b>Frameworks:</b> CI 3, CI 4, Laravel, TensorFlow, PyTorch, Bootstrap, TailWind</li>
            <li><b>Tools & Technologies:</b> Git</li>
          </ul>
          ...
          <div class="card-content">
            <div class="row">
              <div class="col s12 m2">
                <a href="https://www.pradivi.online/" target="_blank"><img alt="Pradivi logo" src="assets/img/logo_pradivi6.png" class="responsive-img center-block" /></a>
              </div>
            </div>
            ...
            <ul>
              ...
              <li>
                <a href="https://www.pradivi.online/">LINK</a>
              </li>
            </ul>
          </div>
          <div class="card-action">
            <span>July 2021 - Nov 2021 | Sukabumi, Indonesia</span>
          </div>
        </div>
    </section>
            ...
            <div class="col s12 m6 l4">
                <div class="card medium">
                    <div class="card-image waves-effect waves-block waves-light">
                        <img alt="music streaming app" src="/assets/img/project-blog-logo.jpg" style="height: 100%; width: 100%" class="activator" />
                    </div>
                    <div class="card-content">
                        <span class="card-title activator teal-text hoverline"><?php echo $project['name'];?><i class="mdi-navigation-more-vert right"></i></span>
                    </div>
                    <div class="card-reveal">
                        <span class="card-title grey-text"><small>Accomplishments</small><i class="mdi-navigation-close right"></i></span>
                        <ul>
                            <li><b>Tools:</b> HTML, CSS, Bootstrap, Mysql</li>
                            <li><?php echo $project['isi'];?></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col s12 m6 l6">
            <div class="card">
              <div class="card-content">
                <p>
                  <span class="card-title"><a href="https://ummi.ac.id/" target="_blank" class="teal-text hoverline">Universitas Muhammadiyah Sukabumi</a></span>
                </p>
                <p class="brown-text">Sukabumi, IND</p>
                <p>
                  <b>Jurusan: </b>Teknik Informatika
                </p>
        ...
        <p>
          <a aria-label="Call Varad" data-position="top" data-tooltip="Call Varad"
            class="btn-floating btn-large waves-effect waves-light blue-grey tooltipped"><i class="fa fa-phone"></i><a
              aria-label="Call Varad">+62 85255018808</a></a>
        </p>
        <p>
          <a aria-label="Email Varad" href="mailto:ilhamarrahman30@ummi.ac.id" target="_blank" data-position="top"
            data-tooltip="Email Varad" class="btn-floating btn-large waves-effect waves-light blue-grey tooltipped"><i
              class="fa fa-envelope"></i><a aria-label="Email Varad" href="mailto:ilhamarrahman30@ummi.ac.id"
              class="hoverline">ilhamarrahman30@ummi.ac.id</a></a>
        </p>
        <p>
          <a aria-label="View Varad on GitHub" href="https://github.com/Ilhamarrhmn" target="_blank"
            ...
            class="btn-floating btn-large waves-effect waves-light blue-grey tooltipped"><i class="fa fa-github"></i><a
              aria-label="Varad on Github" href="https://github.com/Ilhamarrhmn" class="hoverline"
              target="_blank">github.com/Ilhamarrhmn</a></a>
        </p>
      </div>
    </section>
  </main>
